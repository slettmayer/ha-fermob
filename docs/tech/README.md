...
| [TESTING.md](TESTING.md) | How to run the suite, why the test module loads `protocol.py` by file path, what the 794 tests do and do not establish, and the untested surface |
