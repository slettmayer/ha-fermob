...
- **Test**: `pip install -r requirements_test.txt && python -m pytest tests/ -q` (1119 tests, ~12 s — `test_protocol.py` needs no Home Assistant, the other six use its test harness)
