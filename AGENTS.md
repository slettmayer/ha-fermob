...
- **Test**: `pip install -r requirements_test.txt && python -m pytest tests/ -q` (1024 tests, ~10 s — `test_protocol.py` needs no Home Assistant, the other four use its test harness)
